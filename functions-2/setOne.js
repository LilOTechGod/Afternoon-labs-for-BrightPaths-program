...
const lineFunction = (param1, param2) => `the first parameter is ${param1}. The second parameter is ${param2}`


// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.

lineFunction(1, 2);
console.log(lineFunction(1,2));
...
pricesPlusTax(prices, cb)
function cb(totalCost) {

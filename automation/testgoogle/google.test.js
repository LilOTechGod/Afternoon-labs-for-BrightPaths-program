...
test("can search Google for 'automation'", async () => {
  ...
  await driver.wait(until.titleIs("automation - Google Search"), 9000);
});
...
test("can search Google twice", async () => {
  ...
  await driver.wait(until.titleIs("devMountain - Google Search"), 9000);
  ...
  await driver.wait(until.titleIs("Hackbright - Google Search"), 9000);
});